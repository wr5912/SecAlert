...
```
  ...
  <verify>
    <automated>pytest tests/test_analysis/test_classifier.py -x -q --tb=short 2>/dev/null || (grep -n "router = APIRouter" src/analysis/api.py && grep -n "@router.post.*classify" src/analysis/api.py && grep -n "@router.post.*restore" src/analysis/api.py && grep -n "@router.get.*fp-rate" src/analysis/api.py)</automated>
  </verify>
...
```
  ...
  <verify>
    <automated>pytest tests/test_analysis/conftest.py -x -q 2>/dev/null || (python -c "import sys; sys.path.insert(0, 'tests'); from test_analysis.conftest import sample_chain_data, false_positive_chain_data; print('Fixtures loaded OK')")</automated>
  </verify>
...
```
  ...
  <verify>
    <automated>pytest tests/test_analysis/test_classifier.py -x -q --tb=short</automated>
  </verify>
...
```
  ...
  <verify>
    <automated>pytest tests/test_analysis/test_severity.py tests/test_analysis/test_metrics.py -x -q --tb=short</automated>
  </verify>
